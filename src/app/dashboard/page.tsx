...
const T = {
  uz: {
    ...
    walletSub: "Toʻlov tarixi va toʻlov usullari. Dodo Payments orqali xavfsiz toʻlov.",
    ...
    payMethod: "Toʻlov usullari", topUpNote: "Toʻlov maʼlumotlari PRIMIO serverida saqlanmaydi. Dodo Payments shifrlaydi.",
    ...
    kpiSpentHint: "Hammasi Dodo Payments orqali", kpiActiveHint: "Hozir jonli", kpiImprHint: "Barcha vaqt",
    payOpts: [
  ...
  en: {
    ...
    walletSub: "Payment history and payment methods. Secure payments via Dodo Payments.",
    ...
    payMethod: "Payment methods", topUpNote: "Payment details are never stored on PRIMIO servers. Encrypted by Dodo Payments.",
    ...
    kpiSpentHint: "All via Dodo Payments", kpiActiveHint: "Currently live", kpiImprHint: "All time",
    payOpts: [
