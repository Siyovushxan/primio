...
const MATH_CARD_STYLES = [
  { labelColor: "#A855F7", valColor: "#EDE9FE", bg: "#1A1230", borderColor: "#2D1F50" },
          ...
          <div className="rg-hero">
            ...
            <div style={{ background: "#1A1230", border: "1px solid #2D1F50", borderRadius: 18, padding: 20 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
                <span style={{ fontSize: ".72rem", letterSpacing: ".1em", textTransform: "uppercase", color: "#6D5B8E", fontWeight: 700 }}>{t.ruleDemoLabel}</span>
              ...
              {t.homeCats.map((c) => (
                <Link key={c.name} href={`/browse?category=${encodeURIComponent(c.name)}`} style={{ textAlign: "left", background: "#1A1230", border: "1px solid #2D1F50", borderRadius: 14, padding: 17, color: "#EDE9FE", textDecoration: "none", display: "block" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                    ...
                    <span style={{ fontSize: ".68rem", color: "#6D5B8E" }}>{t.catForFirst}</span>
                  </div>
                  <div style={{ fontSize: ".72rem", color: "#6D5B8E", marginTop: 4 }}>{c.count} {t.catAdsCount} {c.min}</div>
                </Link>
              ))}
            </div>
          </div>
              ...
              {t.whoCards.map((w) => (
                <div key={w.title} style={{ background: "#1A1230", border: "1px solid #2D1F50", borderRadius: 16, padding: 22 }}>
                  ...
                  <div style={{ padding: "12px 14px", borderRadius: 11, background: "#160F2A", border: "1px solid #2D1F50" }}>
                    <div style={{ fontSize: ".68rem", letterSpacing: ".08em", textTransform: "uppercase", color: "#6D5B8E", fontWeight: 700, marginBottom: 5 }}>{t.whoExampleLabel}</div>
